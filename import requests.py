...
with st.container():
    ...
    with left_coloumn:
        st.subheader('_Skeptix solutions_:fast_forward:')
...
oglst=["","Chicken/Meat","Fish","Cottage cheese","Rice","Wheat","Sugar","Egg","Fruits","Milk","Pulses"]
...
if m:
    if res=="Rice":
        ...
        if rs == "PCOD":
            ...
            st.subheader("You don't need to cut out sugar from your diet if you have diabetes.You just need to Limit the intake of free sugars to less than 10 percent of total daily calorie (energy) intake.")
            st.write("##")
...
if __name__ == "__main__":
    st.write("Thank you for using our dietary recommendation tool!")